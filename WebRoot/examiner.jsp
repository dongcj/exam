...
<head>
	...
	<script src="inc/login3.js"></script>
	<style>
...
<body onkeydown="keys()">
	...
	<div class="login">
		<div class="loginform">
			...
			身份证号码：<input type="text" class="txt" name="sfzhm" id="sfzhm" value="" style="width:130px" />&nbsp; 
			...
			<input type="button" class="btn" value="使用标准登陆界面登陆" onclick="location.href='login.jsp'" style="width:140px" />
			</form>
		</div>
